...
const SearchBar=()=>{
    ...
    return (
        <div className={style.searchbar}>
            <input type="text" placeholder="Search..." onChange={e => handleInputChange(e)} value={name} onKeyPress={e => e.key === 'Enter' && handleSubmit(e)}></input>
            <button className={style.buttonSearch} onClick={e => handleSubmit(e)}>
